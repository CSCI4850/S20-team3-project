...
class GalagaAgent:
        ...
        def predict(self, states):
            n_states = states.shape[0] if (states.ndim is 3 and not params['GRAYSCALE']) or (states.ndim is 3 and params['GRAYSCALE']) else 1 # if single state passed, expand to (1, w, h, c), else (n, w, h, c)
        ...
        def huber_loss(self, target, prediction):
            ...
            return self.importance_weights * loss
